...
CREATE INDEX idx_content_posts_person ON content_posts(person_name);
...
-- Insert the three main profiles
INSERT INTO content_profiles (person_name, content_pillars, brand_voice, key_messaging) VALUES
('Zac',
...
INSERT INTO posting_goals (person_name, platform, posts_per_week, posts_per_month) VALUES
('Zac', 'LinkedIn', 3, 12),
('Zac', 'Twitter', 7, 30),
('Zac', 'Facebook', 2, 8),
('Luke', 'LinkedIn', 3, 12),
