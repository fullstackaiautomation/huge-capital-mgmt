...
import { ArrowLeft, Loader, AlertCircle, Building2, DollarSign, MapPin, FileText, Pencil, CreditCard } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-900 pb-20">
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-gray-800/40 border border-gray-700/40 rounded-xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div className="bg-gray-900/40 rounded-lg border border-gray-700/40 p-4">
              ...
              <p className="text-lg text-white font-semibold mt-2">
                {deal.credit_score ? deal.credit_score : '—'}
              </p>
            </div>
            <div className="bg-gray-900/40 rounded-lg border border-gray-700/40 p-4">
        ...
        {/* Two-column layout: Bank Statements + Recommended Lenders (left) & Funding Positions (right) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Left Column - Bank Statements + Recommended Lenders */}
          <div className="space-y-6">
            ...
            {/* Lender Qualification Grid Section */}
            <section className="bg-gray-800/30 border border-gray-700/30 rounded-xl overflow-hidden">
              <div className="p-6 border-b border-gray-700/30">
                <div className="flex items-center gap-3">
                  <FileText className="w-6 h-6 text-indigo-400" />
                  <div>
                    <h2 className="text-xl font-semibold text-white">Lender Qualification</h2>
                    <p className="text-gray-400 text-sm">Based on revenue, time in business, state, and credit score.</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
                <LenderMatchGrid
                  ...
                  state={deal.state}
                  timeInBusinessMonths={deal.time_in_business_months}
                  creditScore={deal.credit_score}
                  bankStatements={deal.deal_bank_statements.map(s => ({
                    id: s.id,
          ...
          {/* Funding Positions Section - Right Column */}
